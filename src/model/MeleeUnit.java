...
class MeleeUnit extends MilitaryUnit{
     ...
     * 
     */
	public MeleeUnit(Civilization civil) {
     ...
     * {@linkplain model.HybridUnit} or{@linkplain model.MeleeUnit}.
     * 
     * @author valentinos Pariza
     * @since 2/4/2018
	...
	public void battle(MapObject obj) {
		...
		if((!obj.isDestroyed())&&((obj instanceof MeleeUnit)||(obj instanceof HybridUnit) ))
		{
